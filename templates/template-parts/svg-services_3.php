...
<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 252 252" style="enable-background:new 0 0 252 252;">
    <mask id="puzzleMask">
        <rect class='svgMask' x="0" y="0" width="252" height="252" fill="white"  data-svg="3" />
    </mask>
    <path class="shapeFill" d="M115.1,113.8c-3.9,0-7.5,1.4-10.3,3.6V82.7H69.1c4.1-4,6.6-9.6,6.6-15.8c0-12.2-9.9-22.1-22.1-22.1
        ...
        v-34.7c2.8,2.3,6.3,3.6,10.3,3.6c9,0,16.3-7.3,16.3-16.3C131.3,121.2,124.1,113.8,115.1,113.8z"/>
    <path class="shapeFill" d="M240,108c3.4,0,6.6,0.8,9.5,2.2V82.7h-35.7c4.1-4,6.6-9.6,6.6-15.8c0-12.2-9.9-22.1-22.1-22.1
        ...
        C217.9,117.9,227.8,108,240,108z"/>
    <rect x="0" y="0" width="252" height="252" fill="white" mask="url(#puzzleMask)" />
</svg>
