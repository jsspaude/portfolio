<svg id="wpLogo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 252 252" overflow="visible">
    <mask id="wpMask">
        <circle cx="50%" cy="50%" r="100%" class='svgMask' width="75%" height="75%" fill="white"  data-svg="servicesMask"/>
    </mask>
    <g class='test'>
    <path class="shapeFill" d="M125.9,1.7C57.4,1.7,1.6,57.5,1.6,126c0,68.6,55.8,124.3,124.3,124.3c68.5,0,124.3-55.8,124.3-124.3
        ...
        c8.7,15.9,13.7,34.2,13.7,53.6c0,41.2-22.3,77.2-55.6,96.6l34.1-98.7c6.4-15.9,8.5-28.7,8.5-40C224.8,79.8,224.5,76,224,72.4z" mask="url(#wpMask)"/>
    <!-- <rect x="0" y="0" width="252" height="252" fill="white"  /> -->
    </g>
    <circle cx="50%" cy="50%" r="100%" class='svgCirc' width="130%" height="130%" data-svg="servicesCirc"/>
</svg>
