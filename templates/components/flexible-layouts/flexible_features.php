...
<section class="features-container component">
    ...
    <div class='features-wrapper section-wrapper'>  
                <svg id="featuresSVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
                    ...
                    <g id="screens">
                        <rect x="10" y="14.8" data-svg='1' class="outer-screen" width="181" height="122.6" filter='url(#screens-dropshadow)'/>
                        <path class="outer-screen" data-svg='2' filter='url(#screens-dropshadow)' d="M165.8,85.5H120c-4,0-7.3,3.3-7.3,7.3v74.1c0,4,3.3,7.3,7.3,7.3h45.8c4,0,7.3-3.3,7.3-7.3V92.8
                            C173.1,88.8,169.8,85.5,165.8,85.5z"/>
                        <path class="outer-screen" data-svg='3' filter='url(#screens-dropshadow)' d="M73,121.4H54.2c-3.7,0-6.7,3-6.7,6.7V174c0,3.7,3,6.7,6.7,6.7H73c3.7,0,6.7-3,6.7-6.7v-45.9
