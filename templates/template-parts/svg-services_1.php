<svg id="wpLogo" data-svg="services" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 252 252" overflow="visible">

    <filter id="dropshadowRect" height="130%">
    ...
    <g>
        ...
        <path d="M125.9,1.7C57.4,1.7,1.6,57.5,1.6,126c0,68.6,55.8,124.3,124.3,124.3c68.5,0,124.3-55.8,124.3-124.3
